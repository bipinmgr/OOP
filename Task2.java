...
class User{
    public static void main(String[] args) {
        double n1,n2,n3,n4;
        n1=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the first no: "));
        n2=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the second no: "));
        n3=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the third no: "));
        n4=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the fourth no: "));
...
class Three{
    public static void main(String[] args) {
        double math,social,science,hpe;
        math=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the marks of  first : "));
        social=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the marks of second : "));
        science=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the marks of third : "));
        hpe=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the marks of  fourth : "));

        double t_marks=math+social+science+hpe;
        double t_percent=(math+social+science+hpe)/4;
...
class field{
    public static void main(String[] args) {
        ...
        interest = JOptionPane.showInputDialog(null, "Enter you field of interest: ");
...
class Area{
    public static void main(String[] args) {
        ...
        double areaa=(height*base)/2;
        JOptionPane.showMessageDialog(null, "The are of triangle is"+areaa);
    }
}
...
class Cube{
    public static void main(String[] args) {
        ...
        double volume=Math.pow(length,2);
...
class Cuboid{
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "The volume of cuboid is"+volume_cuboid);
...
class Robert{
    public static void main(String[] args) {
        double math,social,science;
        math=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the marks of  first : "));
        social=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the marks of second : "));
        science=Double.parseDouble(JOptionPane.showInputDialog(null, "Enter the marks of third : "));

        double t_marks=math+social+science;
        double t_percent=(math+social+science )/3;
